        ...
        >
          ...
          <div className="flex ">
            <svg
              ...
              width="400"
              height="300"
              className="sm:w-[450px] sm:h-[450px] lg:w-[550px] lg:h-[550px] xl:w-[800px] xl:h-[500px]"
          ...
          <div className="flex flex-col items-start justify-center gap-6">
            ...
            <p className="text-2xl font-serif text-gray-500">
              ...
              like MERN Stack And MEAN Stack Using OpenAI Tools like Open AI
              API. My best experience is to create Some AI based projects and
              deploy them to web applications using SmarterASP.net Server.
            </p>
          </div>
        </div>
...
export function ProjectSection({ children }) {
        ...
        return (
          <a key={index} target="_blank" href={data?.link}>
            <div className="border rounded-lg shadow-lg shadow-black p-3 cursor-pointer">
              <h1 className="font-bold text-xl font-serif text-slate-600 py-3">
                {data?.name}
              </h1>
              {/* description */}
              <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Labore
                vel delectus, voluptatibus veritatis iusto dolor aperiam
                expedita suscipit earum pariatur tenetur quis sit unde cumque
                aut perferendis ut fuga! Obcaecati?
              </p>
            </div>
          </a>
        );

...
export const Education = () => {
  return (
    <div className="flex flex-col w-11/12 mx-auto lg:flex lg:items-center lg:justify-center lg:w-11/12  p-8">
      ...
      >
        ...
        <div>
          <svg
            ...
            width="200px"
            className="sm:w-[400px] sm:h-[400px] md:w-[500px] md:h-[500px] lg:w-[650px] lg:h-[550px]"
            height="200px"
        ...
        <div className="flex flex-col gap-7">
          <h1 className="font-bold font-serif text-3xl  sm:font-bold sm:text-[30px]  md:text-3xl xl:text-[50px] text-center sm:text-start ">
            Education
          </h1>
          <p className="text-3xl font-semibold font-serif mt-7 text-wrap">
            Basic Qualification and Certifcations
          </p>

          <div className="flex gap-8 text-[50px] ">
            <a href="">
              <SiLeetcode className="text-orange-400 cursor-pointer" />
            </a>

            <a
              href="https://www.hackerrank.com/certificates/bf565688ce52"
              target="_blank"
            >
              <SiHackerrank className="text-green-400 bg-white cursor-pointer" />
            </a>
          </div>
        </div>
      </div>
      ...
      <h1 className="font-bold text-3xl  p-2 text-center text-blue-950 font-serif sm:text-3xl xl:text-4xl">
        Degree Received
      </h1>
        ...
        <div className="flex flex-col px-4 ">
          <div className="flex flex-col items-start bg-yellow-600 rounded-md  ">
            <div className="flex flex-col sm:flex-row items-center gap-9 p-3 text-wrap ">
              <h1 className="font-bold text-3xl text-wrap font-serif">
                Kiet Group Of Insititutions
              </h1>
              <p className="font-bold text-3xl font-serif">2019-2023</p>
            </div>

            <div className="p-2">
              <p className="p-2 font-bold text-2xl font-serif">
      ...
      <h1 className="font-bold text-3xl mt-5 p-2 text-center text-blue-950 font-serif sm:text-3xl xl:text-4xl">
        Class 12th
      </h1>

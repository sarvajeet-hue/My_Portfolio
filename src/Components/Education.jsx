...
export const Education = () => {
  return (
    <div className='flex flex-col w-11/12 mx-auto lg:flex lg:items-center lg:justify-center lg:w-11/12  p-8'>
        ...
        <h1 className='font-bold text-3xl  p-2 text-center text-blue-950 font-serif sm:text-3xl xl:text-4xl'>Degree Received</h1>

...
export const Home = () => {
  ...
  return (
    <div className="flex flex-col w-11/12 p-2 mx-auto">
      <div className="flex flex-col sm:flex-row sm:gap-4 sm:mx-auto mt-9 md:gap-10 lg:flex-row lg:gap-6 lg:mx-auto ">
      ...
      <div className="flex flex-col">
        <h1
          className="font-bold text-lg text-center font-serif text-blue-950
        ...
        <div className="flex flex-col sm:flex sm:flex-row xl:p-2 xl:gap-[60px]">
          ...
          <div>
            <svg
              ...
              width="300"
              height="300"
              className="sm:w-[450px] sm:h-[450px] md:w-[500px] md:h-[500px] lg:w-[600px] lg:h-[600px] xl:w-[800px] xl:h-[650px]  p-2"
          ...
          <div className="flex flex-col items-center gap-3 xl:mt-[117px] sm:mt-[75px] lg:mt-[116px] xl:flex xl:flex-col xl:gap-5">
            <h1 className="font-bold text-blue-950 text-lg sm:font-bold sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-serif">

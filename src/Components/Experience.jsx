...
import v2infotech from '../assets/v2infotech.png'
import Logo from '../assets/Logo.png'

export const Experience = () => {

    const [workHiddenClass , setworkHiddenClass] = useState(false)
  ...
  return (
    <div className='w-11/12 flex flex-col gap-2 p-3 sm:flex-col mx-auto mt-16'>
        ...
        {/* top-div  */}
        <div className='flex flex-col  gap-5  sm:flex sm:flex-row w-full 
        xl:gap-[110px]
         '>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <div className={` overflow-hidden transition-all duration-500 ${workHiddenClass === true ? 'max-h-[1000px] opacity-100' : 'max-h-0 opacity-0'}` }>
            ...
            <div className='p-3 flex flex-col items-center sm:flex sm:flex-row gap-3  sm:gap-[40px] '>
              ...
              {/* image-section  */}
                <div>
                  <img src={v2infotech} height={100} width={150} alt="" />
                </div>
                
                {/* circle-div  */}
                <div className='sm:w-[20px] sm:h-[20px] bg-blue-400 sm:rounded-full'>
          ...
          <div className=  {` overflow-hidden transition-all duration-500 ${internshipHiddenClass === true ? 'max-h-[1000px] opacity-100' : 'max-h-0 opacity-0'}`}>
              <div className='p-3 flex flex-col items-center sm:flex sm:flex-row gap-3  sm:gap-[40px] '>
                  ...
                  {/* image-section  */}
                    <div>
                      <img src={Logo} height={100} width={150} alt="" />
                    </div>

      ...
      >
        ...
        <div className="flex flex-col items-start justify-center gap-6">
          ...
          <p className="text-2xl font-serif text-gray-500">
            I have worked with V2INFOTECH as Software Developer.I have also
            worked with some well established companies mostly as Software
            Developer Intern.
          </p>
        </div>
      </div>
          ...
          <div className="p-3 flex flex-col items-center sm:flex sm:flex-row gap-3  sm:gap-[40px] ">
            ...
            <div className="shadow-lg shadow-black-500/5 rounded-md p-3">
              <div className="flex items-center justify-between rounded-md p-3 w-full border-black ">
                ...
                <div className="flex flex-col text-lg">
                  <p className="font-serif text-gray-500">
                    21st June 2022 - 31st October 2022
                  </p>

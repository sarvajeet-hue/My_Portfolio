...
export const ContactMe = () => {
  return (
    <div className="w-11/12 flex flex-col   mx-auto mt-16">
      <div className="w-full flex flex-col gap-6 p-3 sm:flex-row">
        <SvgFile />

        {/* right-side div */}
        <div className="flex flex-col items-center justify-center  gap-6  ">
          <h1 className="font-bold p-2 text-gray-600 text-3xl sm:text-[50px] font-serif">
            Contact Me
          </h1>
          <p className=" p-2 font-serif text-gray-500 sm:text-2xl ">
            I am available on almost every social media. You can message me, I
            will reply within 24 hours. I can help you with React, Angular , Git
            , Github , NodeJS , ExpressJs , MongoDB and Opensource Development.
          </p>
...
export const Resume = () => {
  return (
    <div>
      <a
        target="_blank"
        href="https://drive.google.com/file/d/19ht2lhLS2c7MA_3gJhkNUPN7P3ktJ0TU/view"
      >
        <PrimaryButton>
            See My Resume
        </PrimaryButton>
